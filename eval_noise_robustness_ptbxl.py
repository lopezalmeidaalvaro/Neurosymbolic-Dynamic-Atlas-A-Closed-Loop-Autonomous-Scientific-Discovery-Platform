...
def main():
    ...
    model_configs = [
        {"name": "SimpleResNet1D", "class": SimpleResNet1D, "pth": "checkpoints/ptbxl/resnet_base.pth"},
        {"name": "SimpleLSTM1D", "class": SimpleLSTM1D, "pth": "checkpoints/ptbxl/lstm_base.pth"},
        {"name": "ECGNeuralODE", "class": ECGNeuralODE, "pth": "checkpoints/ptbxl/ode_base.pth"},
        {"name": "PatchTST", "class": PatchTST, "pth": "checkpoints/ptbxl/patchtst_base.pth"},
        {"name": "TimesNet", "class": TimesNet, "pth": "checkpoints/ptbxl/timesnet_base.pth"},
        {"name": "ResNet18_1D", "class": ResNet18_1D, "pth": "checkpoints/ptbxl/resnet18_base.pth"}
    ]
