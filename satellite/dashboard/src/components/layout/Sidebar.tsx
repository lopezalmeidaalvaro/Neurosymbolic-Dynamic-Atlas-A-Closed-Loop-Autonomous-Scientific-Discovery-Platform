...
import {
  LayoutDashboard, BookOpen, Sparkles, Orbit, GitBranch, BarChart3, ScrollText,
  Map, ChevronLeft, ChevronRight, Zap, ExternalLink, GitCompare,
} from 'lucide-react';
...
const ICON_MAP: Record<string, React.ComponentType<{ size?: number; className?: string }>> = {
  LayoutDashboard, BookOpen, Sparkles, Orbit, GitBranch, BarChart3, ScrollText, Map, GitCompare,
};
