...
class GeometryOptimizer:
    ...
    def evaluate_objectives(self, x_vector):
        ...
        res = net.simulate(duration=5400, dt=10.0, orbit_period=self.period, Q_solar_func=orbit_heat)
        ...
        complexity = (params["fin_density"] * 0.04 + 
    ...
    def run_optimization(self, n_init=200, n_bayes=300):
        ...
        """
        print(f"[*] Starting radiator geometry optimization: {n_init} initial samples + {n_bayes} Bayesian iterations...")
        ...
        optimal_design = {self.param_keys[i]: float(best_x[i]) for i in range(len(self.param_keys))}
    ...
    def generate_report(self, pareto_df, optimal_design):
        ...
        report = f"""# Radiator Geometry and Topology Optimization Report
