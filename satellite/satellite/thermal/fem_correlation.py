...
class FEMCorrelator:
    ...
    def execute_correlation_suite(self):
        ...
        cases = [
            ...
            {
                "id": 4,
                "name": "Hot Case (High Solar, CPU 25W)",
                "power": 25.0,
                "area": 0.15,
                "eps": 0.85,
                "solar_enabled": True,
            ...
            {
                "id": 10,
                "name": "Transient Power Step (5-30W)",
                "power": 30.0,
                "area": 0.15,
                "eps": 0.85,
                "solar_enabled": True,
    ...
    def plot_scatter(self, twin, fem, output_path):
        ...
        ax.plot(
            ...
            linestyle="--",
            linewidth=2.0,
            label="Ideal Equivalence Line (y=x)",
        )
        ...
        ax.scatter(
            ...
            s=15,
            edgecolors="none",
            label="Thermal Solver Datapoints",
        )
        ...
        ax.text(
            min_t + 5,
            max_t - 15,
            f"Overall R² Correlation: {r2:.4%}\nOverall RMSE: {rmse:.4f}°C",
            color="white",
            bbox=dict(
                facecolor="#0f172a", edgecolor="#1e293b", boxstyle="round,pad=0.8"
            ),
        )

        ax.set_title(
            "LEO Cubesat Multi-Node Digital Twin vs. Professional FEM",
            color="white",
            fontsize=12,
            pad=15,
        )
    ...
    def generate_report(self, df):
        ...
        report = r"""# FEA/FEM Professional Correlation Report
