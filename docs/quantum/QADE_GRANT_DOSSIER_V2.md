...
This dossier updates our technical and financial case using the verified results of QADE’s real-execution benchmarks (`COMPILER_COMPARISON_REAL.csv`), establishing a clear roadmap from product candidate to commercial pilot.
