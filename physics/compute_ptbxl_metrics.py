...
def main():
    ...
    model_configs = [
        {"name": "resnet", "class": SimpleResNet1D, "base_pth": "models/ptbxl/resnet_base.pth", "ft_pth": "models/ptbxl/resnet_ft.pth", "idx": 0},
        {"name": "lstm", "class": SimpleLSTM1D, "base_pth": "models/ptbxl/lstm_base.pth", "ft_pth": "models/ptbxl/lstm_ft.pth", "idx": 1},
        {"name": "ode", "class": ECGNeuralODE, "base_pth": "models/ptbxl/ode_base.pth", "ft_pth": "models/ptbxl/ode_ft.pth", "idx": 2},
        {"name": "patchtst", "class": PatchTST, "base_pth": "models/ptbxl/patchtst_base.pth", "ft_pth": "models/ptbxl/patchtst_ft.pth", "idx": 3},
        {"name": "timesnet", "class": TimesNet, "base_pth": "models/ptbxl/timesnet_base.pth", "ft_pth": "models/ptbxl/timesnet_ft.pth", "idx": 4},
        {"name": "resnet18", "class": ResNet18_1D, "base_pth": "models/ptbxl/resnet18_base.pth", "ft_pth": "models/ptbxl/resnet18_ft.pth", "idx": 5}
    ]
