...
def main():
    ...
    plt.savefig(
        os.path.join(ARTIFACTS_DIR, "jacobian_determinant.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
    ...
    plt.savefig(
        os.path.join(ARTIFACTS_DIR, "latent_instability.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
    ...
    plt.savefig(
        os.path.join(ARTIFACTS_DIR, "gp_prediction.png"), dpi=300, bbox_inches="tight"
    )
    plt.close()
