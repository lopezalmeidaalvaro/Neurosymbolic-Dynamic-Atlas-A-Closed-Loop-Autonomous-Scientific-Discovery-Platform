...
- **Reality Gap Score:** `0.8727` (**CRITICAL** status)
- **Evidence Coverage:** `100.00%`
- **Scientific Traceability:** `100.00%`
- **Speculation Ratio:** `9.09%`
...
| :--- | :--- | :---: | :---: |
| **0** | Level 0: Only generated | 0 | 0.0% |
| **1** | Level 1: Sanity Checked (Consistency) | 0 | 0.0% |
| **2** | Level 2: Statistical Validation (Skeptic Bounds) | 1 | 9.1% |
| **3** | Level 3: Replication Sweeps | 0 | 0.0% |
| **4** | Level 4: Cross-Evidence Validation | 10 | 90.9% |
| **5** | Level 5: Physical Hardware-in-the-Loop (HIL) | 0 | 0.0% |

- **Normalized Mean Validation Depth:** `0.1273`
...
| :--- | :---: | :---: |
| **Evidence Coverage** | 1.0000 | Proportional |
| **Traceability Score** | 1.0000 | Proportional |
| **Normalized Depth** | 0.1273 | Proportional |
| **Reality Gap** | **0.8727** | **[ CRITICAL ]** |
