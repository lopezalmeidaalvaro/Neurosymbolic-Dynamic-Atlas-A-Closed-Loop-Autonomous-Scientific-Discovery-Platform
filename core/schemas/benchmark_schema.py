...
class PerformanceMetrics(BaseModel):
    ...
    """
    runtime_seconds: float = Field(..., description="Execution/runtime duration in seconds")
    peak_ram_mb: Optional[float] = Field(None, description="Peak RAM usage in megabytes")
    cpu_usage_pct: Optional[float] = Field(None, description="Average CPU usage percentage")
