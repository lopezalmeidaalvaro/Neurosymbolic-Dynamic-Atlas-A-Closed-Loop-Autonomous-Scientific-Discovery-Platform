...
def main():
    ...
    if anthropic_key:
        print("  ANTHROPIC_API_KEY  : CONFIGURED (Length: {})".format(len(anthropic_key)))
    else:
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("  Docker Engine      : INSTALLED BUT ACCESSIBILITY FAILED (Is Docker Desktop running?)")
        ...
        print("  2. Complete installation, reboot, and ensure Docker Desktop is running.")
        print("  3. Subprocess execution fallback mode will be automatically used in the sandbox.")
    ...
    if all_ok:
        ...
        print("Algunas dependencias fallaron: {}".format([k for k, v in results.items() if v == "FAILED"]))
    print("=" * 70)
