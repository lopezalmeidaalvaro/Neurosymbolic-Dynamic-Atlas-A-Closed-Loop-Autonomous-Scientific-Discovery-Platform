...
def test_knowledge_dashboard(temp_docs_dir):
        ...
        def __init__(self):
            self.store_dict = {
                ...
                "quantum:evolution:history": [
                    {
                        "best_score": 0.95,
                        "average_population_score": 0.70,
                        "diversity_metric": 0.30,
                    },
                    {
                        "best_score": 0.98,
                        "average_population_score": 0.75,
    ...
    metrics = dashboard.generate_report(
        transfer_metrics={
            "cold_convergence_generations": 12,
            "warm_convergence_generations": 6,
            "speedup": 2.0,
        },
