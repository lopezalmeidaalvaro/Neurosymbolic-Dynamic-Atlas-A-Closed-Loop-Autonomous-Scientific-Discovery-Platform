...
class ExperimentTracker:
    ...
    def log_experiment(
        self, system, module, seed, hyperparameters, results, status="completed"
    ):
        """
        ...
        content_str = (
            f"{system}_{module}_{seed}_{json.dumps(hyperparameters, sort_keys=True)}"
        )
