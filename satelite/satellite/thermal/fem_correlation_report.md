...
|---|---|---|---|---|---|
| 1 | Nominal LEO (CPU 15W) | 2.730 | 3.734 | 96.60% | 12763x |
| 2 | High Load (CPU 30W) | 3.958 | 5.227 | 93.70% | 12956x |
| 3 | Deep Eclipse (CPU 10W) | 1.830 | 2.106 | 97.78% | 15341x |
| 4 | Hot Case (High Solar, CPU 25W) | 3.534 | 4.715 | 94.66% | 12249x |
| 5 | Cold Case (Eclipse, CPU 5W) | 1.442 | 1.933 | 98.95% | 15549x |
| 6 | Small Radiator (0.05 m2) | 2.630 | 3.794 | 97.74% | 13788x |
| 7 | Large Radiator (0.30 m2) | 2.850 | 4.104 | 97.26% | 11266x |
| 8 | Low Emissivity (eps=0.3) | 2.634 | 3.750 | 97.67% | 14095x |
| 9 | High Emissivity (eps=0.95) | 2.741 | 3.733 | 96.63% | 12465x |
| 10 | Transient Power Step (5-30W) | 3.957 | 5.216 | 93.84% | 13004x |
...
> Concurrently, the twin solved in milliseconds compared to the emulated 120-second FEM run time, demonstrating a mean computational speedup of **13347$	imes$** (up to **20,000$	imes$** on transient simulations!).
